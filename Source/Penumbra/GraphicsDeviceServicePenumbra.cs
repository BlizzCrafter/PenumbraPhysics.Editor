...
#pragma warning disable 67, CS1591

namespace Penumbra
{
    public class GraphicsDeviceServicePenumbra : IGraphicsDeviceService
    {
        private static GraphicsDeviceServicePenumbra _singletonInstance;
        private static int _referenceCount;
        private readonly PresentationParameters _parameters;

        private GraphicsDeviceServicePenumbra(IntPtr windowHandle, int width, int height)
        {
